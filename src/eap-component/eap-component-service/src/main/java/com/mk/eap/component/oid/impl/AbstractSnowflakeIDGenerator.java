...
public abstract class AbstractSnowflakeIDGenerator implements IDGenerator {
     ...
     * 集群机器ID占用位数
     *//*
    protected static final long DATACENTER_ID_BITS = 6L;//10L
    *//**
     * 最多支持集群机器的数量，1023
     *//*
    protected static final long MAX_DATACENTER_ID = 63L;//-1L ^ (-1L << DATACENTER_ID_BITS);
    *//**
     * 序列号占用位数
     *//*
    protected static final long SEQUENCE_BITS = 10L;//12L
    *//**
