...
public class ZkManager implements Closeable {
    ...
    private static final String DEFAULT_ZNODE_VALUE = "yj-machineID";
    private static final String DEFAULT_ACL_SCHEME = "digest";
    private static final String DEFAULT_ACL_AUTH = "yj_machineID:test1234";
    private static final String DEFAULT_CONNECT_STRING = "zookeeper.mk.com:2181";
    ...
    @Getter
    @Setter
    private String connectString = PropertyUtil.getPropertyByKey("zkserver");//DEFAULT_CONNECT_STRING;
