package com.mk.eap.component.cache.redis.impl;
...
public class StringRedisDao extends AbstractBaseRedisDao<String, Object> {
     ...
     * @throws Exception
     */
    public boolean addObject(final String key, final Object object, final Long timeout, Class<?> clazz) throws ClassCastException {
	...
	public boolean updateString(final String key, final String value) {
		...
		boolean result = redisTemplate.execute(new RedisCallback<Boolean>() {
			public Boolean doInRedis(RedisConnection connection) throws DataAccessException {
				...
				Long expireTime = connection.ttl(keyBytes);
				connection.set(keyBytes, value.getBytes());
